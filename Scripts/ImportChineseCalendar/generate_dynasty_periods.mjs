...
const ORTHODOX_PERIOD_SPECS = [
  periodSpec("qin", "秦", -220, -205, "秦 (公元前221 — 前207)"),
  periodSpec("western_han", "两汉", -205, 8, "西汉 (公元前206-公元8)"),
  periodSpec("xin", "两汉", 8, 23, "新 (8-23)"),
  periodSpec("gengshi", "两汉", 23, 25, "更始 (23-25)"),
  periodSpec("eastern_han", "两汉", 25, 220, "东汉 (25 — 220)"),
  periodSpec("cao_wei", "魏晋南北朝", 220, 265, "曹魏 (220 — 265)"),
  periodSpec("western_jin", "魏晋南北朝", 265, 317, "西晋 (265-317)"),
  periodSpec("eastern_jin", "魏晋南北朝", 317, 420, "东晋 (317-420)"),
  periodSpec("liu_song", "魏晋南北朝", 420, 479, "宋 (420-479)"),
  periodSpec("southern_qi", "魏晋南北朝", 479, 502, "齐 (479-502)"),
  periodSpec("southern_liang", "魏晋南北朝", 502, 557, "梁 (502-557)"),
  periodSpec("chen", "魏晋南北朝", 557, 589, "陈 (557-589)"),
  periodSpec("sui", "隋", 589, 618, "隋 (581 — 618); 正统期接陈亡后的 589 年"),
  periodSpec("tang", "唐", 618, 907, "唐 (618 — 907)"),
  periodSpec("later_liang", "五代", 907, 923, "五代梁 (907 — 923)"),
  periodSpec("later_tang", "五代", 923, 936, "五代唐 (923 — 936)"),
  periodSpec("later_jin", "五代", 936, 947, "五代晋 (936 — 946); 正统边界使用半开区间 [936, 947)"),
  periodSpec("later_han", "五代", 947, 951, "五代汉 (947 — 950); 正统边界使用半开区间 [947, 951)"),
  periodSpec("later_zhou", "五代", 951, 960, "五代周 (951 — 960)"),
  periodSpec("northern_song", "两宋", 960, 1127, "北宋 (960 — 1127)"),
  periodSpec("southern_song", "两宋", 1127, 1279, "南宋 (1127 — 1279)"),
  periodSpec("yuan", "元", 1279, 1368, "元; 正统期从南宋亡后的 1279 年起算"),
  periodSpec("ming", "明", 1368, 1644, "明 (1368 — 1644)"),
  periodSpec("qing", "清", 1644, 1912, "清; 正统期从 1644 年起算"),
  periodSpec("republic_of_china", "民国", 1912, 1949, "中华民国; 首版正统期按 1912 — 1949"),
